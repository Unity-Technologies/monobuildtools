...
if ($artifact)
{
	...
	for my $file ('libmonoboehm-2.0.dylib','libmonobdwgc-2.0.dylib','libmonosgen-2.0.dylib','libMonoPosixHelper.dylib','libmonoruntime-il2cpp.a','libwapi.a','libmonoutils-il2cpp.a','libeglib.a')
	{
