...
if ($artifact)
{
	...
	for my $file ('libmonobdwgc-2.0.dylib','libmonosgen-2.0.dylib','libMonoPosixHelper.dylib','libmonoruntime-il2cpp-bdwgc.a','libwapi.a','libmonoutils-il2cpp.a','libeglib.a')
	{
